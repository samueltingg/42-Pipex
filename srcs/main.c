...
/*   Updated: 2024/03/26 10:21:47 by sting            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void info_setup_here_doc(int argc, char **argv, t_info *info)
{
	...
	close(info->fd_in); // have to close and reopen as RDONLY, as file position pointer is at eof
